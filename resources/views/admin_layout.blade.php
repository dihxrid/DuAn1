...
<html lang="en">
<head>
<title>HT Fresh Shop Admin</title>
<meta charset="UTF-8" />
...
<div id="content">
  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lb"> <a href="{{URl::to('/all-brand-product')}}"> <i class="icon icon-inbox"></i> Thương Hiệu Sản Phẩm</a> </li>
      <li class="bg_lb"> <a href="{{URl::to('/all-product')}}"> <i class="icon-shopping-cart"></i> Sản Phẩm </a> </li>
      <li class="bg_lb"> <a href="{{URl::to('/manage-order')}}"> <i class="icon icon-signal"></i> Đơn Hàng </a> </li>
      <li class="bg_lb"> <a href="{{URl::to('/manage-slider')}}"> <i class="icon icon-picture"></i> Slide </a> </li>
    </ul>
  </div>
 @yield('admin_content')
</div>
