...
<body>
    <div class="container" style="background:#222;border-radius:12px;padding:15px;">
        <div class="col-md-12">
            <p style="text-align:center; color:#fff;">Đây là email tự động>Quý khách không trả lời email này</p>
            <div class="row" style="background:cadebtblue;padding:15px">
                <div class="col-md-6" style="text-align: center;color:#fff;font-weight:bold;font-size:30px">
                    <h4 style="margin:0">CỬA HÀNG BÁN TRÁI CÂY TƯƠI</h4>
                    <h5 style="margin:0">DỊCH VỤ BÁN HÀNG - VẬN CHUYỂN - NHẬP KHẨU CHUYÊN NGHIỆP</h5>
                </div>
                ...
                <div class="col-md-12">
                    <p style="color: #fff;font-size:17px;">Bạn hoặc một ai đó đã đăng kí dịch vụ tại shop với thông tin như sau:</p>
                ...
                <p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="https://hieutantutorial.com/">Shop</a>
                    ,hoặc liên hệ qua số hotline <span style="text-decoration:underline;color:blue">19005689</span>
                    .Xin cảm ơn quý khách đã đặt hàng ở shop chúng tôi </p>
            </div>
        </div>
    </div>
</body>
