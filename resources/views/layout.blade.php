            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <a href="#"><image width="500" height="250" href="#" src="{{URL::to('/frontend/image/banner/banner-1.jpg')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <a href="#"><image width="500" height="250" src="{{URL::to('/frontend/image/banner/banner-2.jpg')}}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
