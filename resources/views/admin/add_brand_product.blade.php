      ...
      <div class="widget-content nopadding">
        <form action="{{URL::to('/save-brand-product')}}" method="post" class="form-horizontal">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input data-validation="length" data-validation-length="min3" data-validation-error-msg="nhập ít nhất 3 ký tự" type="text" name="brand_product_name" class="span11" placeholder="Nhập Tên Thương Hiệu Sản Phẩm" />
            </div>
          </div>
          <div class="control-group">
            <label class="control-label">Mô Tả Thương Hiệu :</label>
            <div class="controls">
              <textarea style="resize: none;" name="brand_product_desc" class="span11" rows="6" placeholder="Nhập Mô Tả Thương Hiệu"></textarea>
            </div>
          </div>
          <div class="control-group">
