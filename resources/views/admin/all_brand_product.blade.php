            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td class="taskOptions">
                  ...
                  <a href="{{URL::to('/delete-brand-product',$cate_pro->brand_id)}}" onclick="return confirm('Bạn Có Muốn Xoá?')" class="tip-top" data-original-title="Delete"><i class="icon-remove"></i></a>
                </td>
              </tr>
              @endforeach
            </tbody>
